...
above). [`docs/ti-reference.md`](docs/ti-reference.md) has curated notes from the official
TI-84 Plus guidebook (window vars, Y=/DRAW/GDB, Lists, Matrices, Strings) if you need to
