...
@pytest.mark.skip(
    reason=(
        "getkey.bas needs a real getKey() implementation;"
        " MockIO.getkey() raises NotImplementedError by design"
    )
)
...
@pytest.mark.skip(
    reason=(
        "menu.bas needs a real menu() implementation;"
        " MockIO.menu() raises NotImplementedError by design"
    )
)
